...
//    private CastContext mCastContext;
    ...
    private int mMenuIdToInflate = -1;
            ...
            if (mItemToOpenWhenDrawerCloses >= 0) {
                ...
                switch (mItemToOpenWhenDrawerCloses) {
                    case R.id.navigation_allmusic:
                        activityClass = FirstJGDActivity.class;
                        break;
...
//        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(getmMenuIdToInflate(), menu);
//
//        if (mCastContext != null) {
...
//        }
    ...
    protected void initializeToolbar(int menuId) {
        ...
        setmMenuIdToInflate(menuId);
        mToolbar.inflateMenu(getmMenuIdToInflate());
    ...
    private void populateDrawerItems(NavigationView navigationView) {
        ...
        if (FirstJGDActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_allmusic);
        } else if (MainActivity.class.isAssignableFrom(getClass())) {
    ...
    public int getmMenuIdToInflate() {
        return mMenuIdToInflate;
    }

    public void setmMenuIdToInflate(int mMenuIdToInflate) {
        this.mMenuIdToInflate = mMenuIdToInflate;
    }
}
